...
function renderHighlightIndex(highlights, highlightListEl, highlightDrawer, contentEl) {
  if (!highlightListEl) {
    return;
  }
...
function setupHighlights(contentEl, highlightToolbar, applyHighlightBtn, clearHighlightsBtn, highlightDrawer, highlightListEl) {
  const highlights = loadHighlights();
  applyHighlights(highlights, contentEl);
  renderHighlightIndex(highlights, highlightListEl, highlightDrawer, contentEl);
